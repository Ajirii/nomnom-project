...
const initialQuests: Quest[] = [
  {
    ...
    description: "Cook a dish from a cuisine you've never heard of. Bonus points if you can pronounce it!",
    rewardCurrency: 30,
    rewardHunger: 40,
    status: "available"
  },
  {
    ...
    description: "Perfectly fry an egg. It's a simple task… unless you're still trying to figure out how not to turn it into scrambled eggs.",
    rewardCurrency: 15,
    rewardHunger: 20,
    status: "available"
  },
...
const Quests = () => {
  ...
  const handleAccept = (id: string) => {
    setQuests(prev => prev.map(q => q.questId === id ? { ...q, status: "accepted" } : q));
  };
  ...
  const handleComplete = (id: string) => {
    ...
    setQuests(prev => prev.map(q => q.questId === id ? { ...q, status: "completed" } : q));
  };
          ...
          <div className="modal-content achievements-grid" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="achievement-boxes">
              {achievements.map((a, index) => (
                <div
                  key={index}
                  className={`achievement-tile ${completedCount >= a.threshold ? "unlocked" : "locked"}`}
                >
      ...
      <div className="main">
        ...
        <div className="quest-container">
          <div className="master">
            ...
            <p><strong>Total Coins:</strong> {coinsEarned} 🪙</p>
          ...
          <div className="detail">
            {selectedQuest ? (
              <div>
                ...
                <p><strong>Hunger Reward:</strong> {selectedQuest.rewardHunger}</p>
                <p><strong>Coins:</strong> {selectedQuest.rewardCurrency} 🪙</p>
